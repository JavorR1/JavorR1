...
def spammer():
    ...
    print('')
    print('')
    Write.Print("                                   n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                   n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                   n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                   n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                   n", Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [v{THIS_VERSION}]              n', Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [github.com/JavorR1]           n', Colors.purple_to_blue, interval=0.000)
    Write.Print(" > [discord.gg/mPxA76VNFe]         n", Colors.purple_to_blue, interval=0.000)
