# https://github.com/TT-Tutorials |github.com/JavorR1/JAVOR-Nuker
# Coded / Dev / Owner: JavorR1#0352
# Copyright © JAVOR-Nuker
#########################################################
...
try:
    ...
    with open('data/logins.json', 'w') as f:
            print(f"\n[{g}#\x1b[95m\x1B[37m] Logging Into JAVOR-Nuker")
...
def spammer():
    ...
    print('')
    print('')
    Write.Print("                                 J  A  V  O R  ||  N  U  K   E  R  n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                 J  A  V  O R  ||  N  U  K   E  R  n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                 J  A  V  O R  ||  N  U  K   E  R  n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                 J  A  V  O R  ||  N  U  K   E  R  n", Colors.purple_to_blue, interval=0.000)
    Write.Print("                                 J  A  V  O R  ||  N  U  K   E  R  n", Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [v{THIS_VERSION}]            J  A  V  O R  ||  N  U  K   E  R  n', Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [github.com/JavorR1]         J  A  V  O R  ||  N  U  K   E  R   n', Colors.purple_to_blue, interval=0.000)
    Write.Print(" > [discord.gg/mPxA76VNFe]       J  A  V  O R  ||  N  U  K   E  R  n", Colors.purple_to_blue, interval=0.000)
...
#   JOINER
    if choice == '1':
        ...
        gh = input(f"""
Joiner is in the Paid Version of JAVOR-Nuker!\nIf You Are Wanting to Purchase Make Sure to Checkout the Offical JAVOR-Nuker discord!
                                   
[\x1b[95m1\x1b[95m\x1B[37m] JAVOR-Nuker discord 
[\x1b[95m2\x1b[95m\x1B[37m] Exit
  
[\x1b[95m>\x1b[95m\x1B[37m] Choice?: """)

        if gh in ['01','1']:
            webbrowser.open('https://discord.gg/mPxA76VNFe')
        elif gh in ['02','2']:
            exit = spammer()
        else:
         print('')
...
[\x1b[95m1\x1b[95m\x1B[37m] JAVOR-Nuker Website
[\x1b[95m2\x1b[95m\x1B[37m] Exit
...
#   ABOUT
    if choice == '30':
        Spinner()
        setTitle(f"About    |    ")
        Write.Print("\nHello, thanks for using JAVOR-Nuker!\nif you run into any problems make sure to let me know asap!\nDiscord: JavorR1#0352\nGithub: github.com/JavorR1\nDiscord: https://discord.gg/mPxA76VNFe\n\n", Colors.purple_to_blue, interval=0.015)
