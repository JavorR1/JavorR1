...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str}JAVOR-Nuker FREE    |    Made by JavorR1#0352    |    Tokens: [{counttokens}]")
    elif system == 'posix':
        sys.stdout.write(f"{_str}JAVOR-Nuker FREE    |    Made by JavorR1#0352    |    Tokens: [{counttokens}]")
    else:
        pass
